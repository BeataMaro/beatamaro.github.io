...
function renderAbout() {
  const aboutText = createHtmlFromTemplate(`<section id="about" class="section section-about container border-bottom py-4  about-trigger"><h2 aria-label="About" class="sr-only">About</h2>
  <div class="row row-cols-md-2 row-cols-lg-3 d-flex flex-column flex-md-row mt-4">
  <div class="profile-image col d-flex align-items-md-center bg-light">
  <img src="${profileImage}" alt="profile" class="img-fluid img-thumbnail rounded"/>
  </div>
  ...
  <div class="col col-sm-12 col-md-12 p-5 bg-light">

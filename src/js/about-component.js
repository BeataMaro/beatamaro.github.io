...
function renderAbout() {
  ...
  <p class="text-break fw-light fst-italic">Recently, I gained the RS School <a href="https://app.rs.school/certificate/ihwbzo94" target="_blank" rel="no-referrer" class="link-secondary">JavaScript Certificate</a>, which is the result of a six-month <a href="https://rs.school/" target="_blank" rel="no-referrer" class="link-secondary"><strong>Frontend course at RS School</strong></a>.<br />It consists of practical work and interviews with experienced mentors from the company EPAM.</p><p class="text-break fw-light fst-italic">My strengths are motivation, <strong>attention to detail</strong> and patience. I'm a&nbsp;<strong>team player</strong> always eager to learn more!</p>

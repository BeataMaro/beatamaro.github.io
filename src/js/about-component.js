...
function renderAbout() {
  ...
  <div class="row row-cols-md-2 row-cols-lg-3 d-flex flex-column flex-md-row justify-content-around">
  <div class="col"> 
  <p class="fs-1 fw-bolder lh-sm mt-3 mt-md-none">Hi,</p>
  <p class="fs-1 fw-bolder lh-sm">My name is Beata</p><strong class="fs-4 fw-bold lh-md fst-italic">Junior Frontend Developer with 10 months of commercial experience.</strong>
  ...
  <p class="text-break fw-light fst-italic">Since December I've been working at</p><strong>Webjaksklep Software House as a Junior Frontend Developer.</strong>

...
function renderFooter() {
  const footerTemplate = `<div class="container-fluid p-1"><a class="link" href="https://github.com/BeataMaro/portfolio-BM" target="_blank" rel="no-referrer"><img src="${githubIcon}" alt="gitHub logo" class="footer-icon" /></a><p>&copy; 2023</p></div>`;
